### Code regarding Table 5 of the manuscript

### in this code, Beta* belongs to Rrows(X*)
...
###this way, Beta* belongs to Rrows(X*)
MYSVDAtQTL<-svd(genomesOvertime[nbgeneration, , genomeDefFixedMapWithQTL@pos.add.qtl
$ID])

QTLeffectsMatrixOnAxis<- 0.3*MYSVDAtQTL$v[,1] +  0.3*MYSVDAtQTL$v[,2] + 0.3*MYSVDAtQTL$v[,3]

QTLeffectsMatrix<-matrix(QTLeffectsMatrixOnAxis,ncol=1)
